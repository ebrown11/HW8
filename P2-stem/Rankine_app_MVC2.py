...
from Rankine_GUI2 import Ui_Form
from Rankine_Classes_MVC2 import rankineController
from UnitConversions2 import UnitConverter as UC
...
class MainWindow(qtw.QWidget, Ui_Form):
    ...
    def Calculate(self):
        self.RC.updateModel() #call the updateModel() method of the controller
        pass

    def SelectQualityOrTHigh(self):
        self.RC.selectQualityOrTHigh() #call the selectQualityOrTHigh() methond of the controller
        pass

    def SetPlotVariables(self):
        self.RC.updatePlot() # call the updatePlot() method of the controller
        pass

    def SetUnits(self):
        self.RC.updateUnits() # call the updateUnits() method of the controller
        pass

    def setNewPHigh(self):
        self.RC.setNewPHigh() # call the setNewPHigh() function of the controller
        pass

    def setNewPLow(self):
        self.RC.setNewPLow # call the setNewPLow() function of the controller
        pass
